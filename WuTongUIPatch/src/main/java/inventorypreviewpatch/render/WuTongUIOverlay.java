...
public class WuTongUIOverlay {
    ...
    public static class PreviewOverlay {
        ...
        public static void renderInventoryBackground(InventoryOverlay.InventoryRenderType type, int x, int y, int slotsPerRow, int totalSlots, InventoryOverlay.Context previewData, MinecraftClient mc, DrawContext drawContext) {
            if (INVENTORY_PREVIEW_FIX_MODE.getStringValue().equals("wutong")) {
                ...
                Identifier texture_slots = Identifier.of("inventorypreviewpatch", "textures/preview/overlay/" + id_slots + ".png");
        ...
        public static void renderWuTongInventoryBackground(InventoryOverlay.InventoryRenderType type, InventoryOverlay.Context previewData, int x, int y, int slotsPerRow, int totalSlots, BufferBuilder buffer) {
            ...
            } else if (type == InventoryOverlay.InventoryRenderType.CRAFTER) {
            ...
            } else if (type == InventoryOverlay.InventoryRenderType.ENDER_CHEST) {
        ...
        public static void renderVanillaInventoryBackground(InventoryOverlay.InventoryRenderType type, int x, int y, int slotsPerRow, int totalSlots, BufferBuilder buffer) {
