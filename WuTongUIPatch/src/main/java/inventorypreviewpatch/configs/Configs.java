...
import inventorypreviewpatch.configs.utils.DisplayContainerTitleMode;
import inventorypreviewpatch.configs.utils.DisplayPlayInventoryTitleMode;
...
public class Configs implements IConfigHandler {
    ...
    public static class Fixes {
        ...
        public static final ConfigBoolean Render_Shulkerbox_Background         = new ConfigBoolean("RenderShulkerboxBackground", false, translate("renderShulkerboxBackground")).apply(Fixes_KEY);
